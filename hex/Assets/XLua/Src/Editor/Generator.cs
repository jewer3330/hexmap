...
namespace CSObjectWrapEditor
{
    ...
    public static class Generator
    {
        ...
        static void GenOne(Type type, Action<Type, LuaTable> type_info_getter, XLuaTemplate templateAsset, StreamWriter textWriter)
        {
            ...
            //if (type!=null && type.BaseType != null && type.BaseType == typeof(UnityEditor.Editor))
            //    return;
        ...
        static void GenWrap(IEnumerable<Type> types, string save_path)
        {
            ...
            foreach (var wrap_type in types)
            {
                //if (wrap_type.BaseType!=null && wrap_type.BaseType == typeof(UnityEditor.Editor))
                //    break;
...
#pragma warning restore 618
        ...
        public static void GenAll()
        {
            ...
            int removed = LuaCallCSharp.RemoveAll(type => type.BaseType != null && type.BaseType == typeof(UnityEditor.Editor));
